    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-[#2b2d31] p-6 rounded-lg shadow-lg text-white max-w-lg w-full">
        ...
        <p>
          ...
          particular chat group. Each node represents a user. Global connections
          (for every unique pair within the threshold) are drawn in white at
          lower opacity. When you click on a node, additional connections from
          that node are drawn at full opacity, and the Sidebar displays the
