       ...
       <div className="border-t border-[#4F545C] pt-6">
         ...
         >
           <h3 className="font-semibold mb-2 text-white">
             How to export your Discord chat data for this tool:
           </h3>
           <ol className="list-decimal list-inside space-y-2">
             <li>
               ...
               >
                 DiscordChatExporter GitHub repo
               </a>{" "}
             ...
             <li>
               When the exporter finishes, you'll have a JSON file (e.g., “export.json”).
             </li>
             <li>
               Use the “Upload JSON File” button above to upload your exported chat data.
             </li>
           </ol>
         </div>
       </div>
